...
function HomePageContent() {
  ...
  return (
    <div className="flex h-screen">
      {/* Fixed Sidebar Navigation - Only for logged in users */}
      {/* {Boolean(
            ...
            <div className="mx-auto relative z-10">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="text-center p-8 rounded-2xl bg-gradient-to-br from-green-50 to-blue-50 dark:from-gray-700 dark:to-gray-600 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group">
                  <div className="w-16 h-16 bg-green rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                    <svg
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4 group-hover:text-green transition-colors">
                    Always Available
                  </h3>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
                ...
                <div className="text-center group">
                  <div className="relative mb-4">
                    <div className="text-4xl md:text-5xl font-bold text-green mb-2 group-hover:scale-110 transition-transform duration-300">
                      10K+
                    </div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="bg-gradient-to-br from-green-50 to-blue-50 dark:from-gray-800 dark:to-gray-700 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group">
                  <div className="flex items-center mb-4">
                    <div className="w-12 h-12 bg-green rounded-full flex items-center justify-center mr-4 group-hover:scale-110 transition-transform">
                ...
                <div className=" dark:from-gray-800 dark:to-gray-700 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 italic">
                    "Working from home was isolating until I found Vina. Now I
                    have someone to talk to whenever I need it."
                  </p>
                  <div className="flex text-yellow-400 mt-4">
                    <span className="text-xl">★★★★★</span>
                  </div>
                ...
                <div className=" dark:from-gray-800 dark:to-gray-700 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 italic">
                    "As a busy parent, I don't always have time for therapy.
                    Vina fills that gap perfectly with 24/7 availability."
                  </p>
                  <div className="flex text-yellow-400 mt-4">
                    <span className="text-xl">★★★★★</span>
                  </div>
